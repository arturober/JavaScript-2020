...
function ejercicio4(nombre = "Producto genérico", precio = 100, impuesto = 21) {
    nombre = "" + nombre;
    precio = +precio;
    impuesto = +impuesto;

    if(isNaN(precio) || isNaN(impuesto)) {
        console.error("El precio o el impuesto no son números");
        return;
    }
...
let ejercicio5 = (cadena, trozo) => {
    ...
    if(esta) {
        ...
        console.log(`La cadena "${cadena}" NO contiene "${trozo}"`);
    }
}

ejercicio5("Santiago de Compostela", "COMPO");
ejercicio5("Santiago de Compostela", "hola");
